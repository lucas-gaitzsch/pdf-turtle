...
type RenderData struct {
	...
	FooterHtml string  `json:"footerHtml,omitempty" default:"<div class=\"default-footer\"><span class=\"pageNumber\"></span> of <span class=\"totalPages\"></span></div>"` // Optional html for footer. If empty, the footer html will be parsed from main html (<PdfFooter></PdfFooter>).
